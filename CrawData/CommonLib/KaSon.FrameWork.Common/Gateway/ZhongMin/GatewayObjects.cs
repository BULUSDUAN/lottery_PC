    ...
    public static class ObjectExtension
    {
        ...
        public static string ToAnteString_ZhongMin(this Antecode ante, string gameCode)
        {
                ...
                ante.GameType.Equals("DT", StringComparison.OrdinalIgnoreCase))
            {
                ...
                if (tmp.Length != 3)
                    throw new LogicException("双色球胆拖玩法号码错误 - " + ante.AnteNumber);
                var dan = tmp[0];
                var tuo = tmp[1];
                var lan = tmp[2];
            ...
            if (gameCode.Equals("CTZQ", StringComparison.OrdinalIgnoreCase) &&
                ante.GameType.Equals("TR9", StringComparison.OrdinalIgnoreCase))
                return ante.AnteNumber.Replace("*", "-");
            ...
            if (gameCode.Equals("FC3D", StringComparison.OrdinalIgnoreCase))
            {
                switch (ante.GameType.ToLower())
                {
                    case "ds":
            ...
            switch (gameCode.ToLower())
            {
                case "jclq":
                    switch (gameType.ToLower())
                    {
                        ...
                        case "sfc":
                            return ante
                                .Replace("01", "胜A").Replace("02", "胜B").Replace("03", "胜C").Replace("04", "胜D")
                                .Replace("05", "胜E").Replace("06", "胜F")
                                .Replace("11", "负A").Replace("12", "负B").Replace("13", "负C").Replace("14", "负D")
                                .Replace("15", "负E").Replace("16", "负F")
                                .Replace("胜A", "胜1-5").Replace("胜B", "胜6-10").Replace("胜C", "胜11-15")
                                .Replace("胜D", "胜16-20").Replace("胜E", "胜21-25").Replace("胜F", "胜26+")
                                .Replace("负A", "负1-5").Replace("负B", "负6-10").Replace("负C", "负11-15")
                                .Replace("负D", "负16-20").Replace("负E", "负21-25").Replace("负F", "负26+");
                    }
                    return ante;
                case "jczq":
                case "bjdc":
                    switch (gameType.ToLower())
                    {
                        ...
                        case "sxds":
                            return ante.Replace("SD", "上+单").Replace("SS", "上+双").Replace("XD", "下+单")
                                .Replace("XS", "下+双");
                        case "bf":
                            return ante.Replace("10", "1:0").Replace("20", "2:0").Replace("21", "2:1")
                                .Replace("30", "3:0").Replace("31", "3:1").Replace("32", "3:2").Replace("40", "4:0")
                                .Replace("41", "4:1").Replace("42", "4:2").Replace("50", "5:0").Replace("51", "5:1")
                                .Replace("52", "5:2").Replace("X0", "胜其他")
                                .Replace("00", "0:0").Replace("11", "1:1").Replace("22", "2:2").Replace("33", "3:3")
                                .Replace("XX", "平其他")
                                .Replace("01", "0:1").Replace("02", "0:2").Replace("12", "1:2").Replace("03", "0:3")
                                .Replace("13", "1:3").Replace("23", "2:3").Replace("04", "0:4").Replace("14", "1:4")
                                .Replace("24", "2:4").Replace("05", "0:5").Replace("15", "1:5").Replace("25", "2:5")
                                .Replace("0X", "负其他");
                        case "bqc":
