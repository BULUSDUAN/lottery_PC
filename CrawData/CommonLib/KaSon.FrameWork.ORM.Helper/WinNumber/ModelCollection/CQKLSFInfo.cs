...
namespace KaSon.FrameWork.ORM.Helper.WinNumber.ModelCollection
{
    ...
    public class CQKLSF_2LZS_Info : ImportInfoBase
    {
    ...
    public class CQKLSF_2LZS_InfoCollection : List<CQKLSF_2LZS_Info>
    {
    }
    public class CQKLSF_3LZS_Info : ImportInfoBase
    {
    ...
    public class CQKLSF_3LZS_InfoCollection : List<CQKLSF_3LZS_Info>
    {
    }
     
    public class CQKLSF_DXZS_Info : ImportInfoBase
    {
    ...
    public class CQKLSF_DXZS_InfoCollection : List<CQKLSF_DXZS_Info>
    {
    }
     
    public class CQKLSF_GHZS_Info : ImportInfoBase
    {
    ...
    public class CQKLSF_GHZS_InfoCollection : List<CQKLSF_GHZS_Info>
    {
    }
     
    public class CQKLSF_JBZS_Info : ImportInfoBase
    {
    ...
    public class CQKLSF_JBZS_InfoCollection : List<CQKLSF_JBZS_Info>
    {
    }
     
    public class CQKLSF_JOZS_Info : ImportInfoBase
    {
    ...
    public class CQKLSF_JOZS_InfoCollection : List<CQKLSF_JOZS_Info>
    {
    }
     
    public class CQKLSF_Q1ZS_Info : ImportInfoBase
    {
        public int Red_01 { get; set; }
        public int Red_02 { get; set; }
        public int Red_03 { get; set; }
    ...
    public class CQKLSF_Q1ZS_InfoCollection : List<CQKLSF_Q1ZS_Info>
    {
    }
     
    public class CQKLSF_Q3ZS_Info : ImportInfoBase
    {
        public int DDan { get; set; }
        public int DS { get; set; }
        public int XDan { get; set; }
    ...
    public class CQKLSF_Q3ZS_InfoCollection : List<CQKLSF_Q3ZS_Info>
    {
    }
     
    public class CQKLSF_QJZS_Info : ImportInfoBase
    {
    ...
    public class CQKLSF_QJZS_InfoCollection : List<CQKLSF_QJZS_Info>
    {
    }
     
    public class CQKLSF_TWZS_Info : ImportInfoBase
    {
    ...
    public class CQKLSF_TWZS_InfoCollection : List<CQKLSF_TWZS_Info>
    {
    }
}
