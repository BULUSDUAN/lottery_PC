                    ...
                    try
                    {
                        if (item.Name == "data")
                        {
                            ...
                            foreach (var item1 in data)
                            {
                               ...
                               string issue = item1.expect.Value + "";
                                int year = DateTime.Parse((item1.opentime.Value + "")).Year;
                                if (issue.Length < 4)
                                {
                                    int t = int.Parse(issue);
                                    if (t < 10)
                                    {
                                        issue = year + "00" + t;
                                ...
                                if (issue.Length > 4 && issue.Length < 7)
                                {
                                    string s = issue.Substring(4);
                                    if (s.Length == 1)
                                    {
                                        issue = issue.Substring(0, 4) + "00" + s;
                                    }
                                    if (s.Length == 2)
                                    {
                                        issue = issue.Substring(0, 4) + "0" + s;
                                    }
                                }
                    ...
                    try
                    {
                        if (item.Name == "result")
                        {
                            ...
                            foreach (var item1 in data)
                            {
                                ...
                                int year = DateTime.Parse((item1.preDrawDate.Value + "").Replace("-", "/")).Year;
                                if (issue.Length<4)
                                {
                                    int t = int.Parse(issue);
                                    if (t<10)
