...
namespace KaSon.FrameWork.ORM.DbHelper
{
    ...
    internal class MySqlHelper : IDbHelper
    {
        ...
        public MySqlHelper(OrmConfigInfo info, bool isLLink)
        {
            _IsLLink = isLLink;
            this._connInfo = info;
        ...
        //        {
        //            this.Open();
        //            var columns = dataSource.Columns.Cast<DataColumn>().Select(colum => colum.ColumnName).ToList();
        //            MySqlBulkLoader bulk = new MySqlBulkLoader(this.Conn)
        //            {
        //                FieldTerminator = ",",
