...
{
    public class MySqlFactory : ConstructionFactory
    {
        ...
        internal override IQueryable<T> CreateQuery<T>(Provider.DbProvider provider)
        {
            ...
            return new Query<T>(provider, this.IsLLink);
        }

        internal override IBuilder.IDbBuilder CreateDbBuilder( )
        {
            return new MySqlBuilder(this.IsLLink);
        }
        ...
        {
            return new MySqlDalHelper(provider,this.IsLLink);
        }
        ...
        {
            return new MySqlHelper(base.ConfigInfo, this.IsLLink);
        }
        ...
        {
            return new MySqlParamterBuilder();
        }
