...
using Kason.Net.Common.Algorithms;
using System;
...
namespace Common.Lottery.Gateway.Liangcai
{
    ...
    public static class ObjectExtension
    {
        public static string ToAnteString_LiangCai(this ITicket ticket, string PlayType)
        {
            ...
            if (!string.IsNullOrEmpty(ticket.GameType) &&
                ticket.GameType.Equals("HH", StringComparison.OrdinalIgnoreCase))
            ...
            return string.Format("{0}|{1}|{2}", ConvertGameType(ticket.GameCode, ticket.GameType),
                string.Join(",", strList), ConvertPlayType(ticket.GameCode, PlayType));
        }
        ...
        public static string ConvertPlayType(string gameCode, string playType)
        {
            ...
            {
                case "BJDC":
                    return playType.Replace("P", "").Replace("_", "*").Replace("11*1", "#").Replace("1*1", "单关")
                        .Replace("#", "11*1");
                case "JCZQ":
                case "JCLQ":
        ...
        public static string ToAnteString_LiangCai(this Ticket ticket, string gameCode)
        {
            ...
            foreach (var ante in ticket.AnteCodeList)
                strList.Add(ToAnteString_LiangCai(ante, gameCode,  ante.GameType));
                ...
                case "bjdc":
                    switch (gameType.ToLower())
                    {
                        ...
                        case "zjq":
                            return matchId + "=" + ante.Replace(",", "/");
                        case "sxds":
                            return matchId + "=" + ante.Replace("SD", "上单").Replace("SS", "上双").Replace("XD", "下单")
                                       .Replace("XS", "下双").Replace(",", "/");
                        case "bf":
                            return matchId + "=" + ante.Replace("10", "1:0").Replace("20", "2:0").Replace("21", "2:1")
                                       .Replace("30", "3:0").Replace("31", "3:1").Replace("32", "3:2")
                                       .Replace("40", "4:0").Replace("41", "4:1").Replace("42", "4:2")
                                       .Replace("50", "5:0").Replace("51", "5:1").Replace("52", "5:2")
                                       .Replace("X0", "胜其它")
                                       .Replace("00", "0:0").Replace("11", "1:1").Replace("22", "2:2")
                                       .Replace("33", "3:3").Replace("XX", "平其它")
                                       .Replace("01", "0:1").Replace("02", "0:2").Replace("12", "1:2")
                                       .Replace("03", "0:3").Replace("13", "1:3").Replace("23", "2:3")
                                       .Replace("04", "0:4").Replace("14", "1:4").Replace("24", "2:4")
                                       .Replace("05", "0:5").Replace("15", "1:5").Replace("25", "2:5")
                                       .Replace("0X", "负其它").Replace(",", "/");
                        case "bqc":
                            return matchId + "=" + ante.Replace("33", "3-3").Replace("31", "3-1").Replace("30", "3-0")
                                       .Replace("13", "1-3").Replace("11", "1-1").Replace("10", "1-0")
                                       .Replace("03", "0-3").Replace("01", "0-1").Replace("00", "0-0")
                                       .Replace(",", "/");
                    }
                    return ante;
                case "jczq":
                    switch (gameType.ToLower())
                    {
                        ...
                        case "bf":
                            return matchId + "=" + ante.Replace("10", "1:0").Replace("20", "2:0").Replace("21", "2:1")
                                       ...
                                       .Replace("X0", "9:0")
                                       .Replace("00", "0:0").Replace("11", "1:1").Replace("22", "2:2")
                                       .Replace("33", "3:3").Replace("XX", "9:9")
                                       .Replace("01", "0:1").Replace("02", "0:2").Replace("12", "1:2")
                                       .Replace("03", "0:3").Replace("13", "1:3").Replace("23", "2:3")
                                       .Replace("04", "0:4").Replace("14", "1:4").Replace("24", "2:4")
                                       .Replace("05", "0:5").Replace("15", "1:5").Replace("25", "2:5")
                                       .Replace("0X", "0:9").Replace(",", "/");
                        case "bqc":
                            return matchId + "=" + ante.Replace("33", "3-3").Replace("31", "3-1").Replace("30", "3-0")
                                       .Replace("13", "1-3").Replace("11", "1-1").Replace("10", "1-0")
                                       .Replace("03", "0-3").Replace("01", "0-1").Replace("00", "0-0")
            ...
            switch (gameCode.ToLower())
            {
                ...
                case "jczq":
                    switch (gameType.ToLower())
                    {
                        ...
                        case "bf":
                            return "CBF>" + matchId + "=" + ante.Replace("10", "1:0").Replace("20", "2:0")
                                       .Replace("21", "2:1").Replace("30", "3:0").Replace("31", "3:1")
                                       .Replace("32", "3:2").Replace("40", "4:0").Replace("41", "4:1")
                                       .Replace("42", "4:2").Replace("50", "5:0").Replace("51", "5:1")
                                       .Replace("52", "5:2").Replace("X0", "9:0")
                                       .Replace("00", "0:0").Replace("11", "1:1").Replace("22", "2:2")
                                       .Replace("33", "3:3").Replace("XX", "9:9")
                                       .Replace("01", "0:1").Replace("02", "0:2").Replace("12", "1:2")
                                       .Replace("03", "0:3").Replace("13", "1:3").Replace("23", "2:3")
                                       ...
                                       .Replace("0X", "0:9").Replace(",", "/");
                        case "bqc":
                            return "BQC>" + matchId + "=" + ante.Replace("33", "3-3").Replace("31", "3-1")
                                       .Replace("30", "3-0")
                                       .Replace("13", "1-3").Replace("11", "1-1").Replace("10", "1-0")
                                       .Replace("03", "0-3").Replace("01", "0-1").Replace("00", "0-0")
                                       .Replace(",", "/");
