...
namespace Kason.Net.Common
{
    ...
    public class Log4Log : IKgLog
    {
        ...
        public static void Fatal(string message="",Exception exception=null) {
            ...
            if (fatellogger == null) {
                fatellogger = InitConfigInfo.logFactory.CreateLogger(repository,"Log4Log_Fatal");//.Fatal(message, exception);
            }
            fatellogger.Log(null,Level.Fatal,message, exception);
        }
        public static void Info(string message = "", Exception exception = null)
        {
            ...
            if (infologger == null)
            {
                infologger = InitConfigInfo.logFactory.CreateLogger(repository, "Log4Log_Info");//.Fatal(message, exception);
            }
            infologger.Log(null, Level.Info, message, exception);
            //infologger.
        }
        public static void Warn(string message = "", Exception exception = null)
        {
            ...
            {
                warninglogger = InitConfigInfo.logFactory.CreateLogger(repository,"Log4Log_Warn");//.Fatal(message, exception);
            }
            warninglogger.Log(null, Level.Warn, message, exception);
        }
        public static void Debug(string message = "", Exception exception = null)
        {
            ...
            if (debuglogger == null)
            {
                debuglogger = InitConfigInfo.logFactory.CreateLogger(repository, "Log4Log_Debug");//.Fatal(message, exception);
            }
            debuglogger.Log(null, Level.Debug, message, exception);
        }
        public static void Error(string message = "", Exception exception = null)
        {
            ...
            if (errorlogger == null)
            {
                errorlogger = InitConfigInfo.logFactory.CreateLogger(repository, "Log4Log_error");//.Fatal(message, exception);
            }
            errorlogger.Log(null, Level.Error, message, exception);
        }
