...
{
    public class MySqlExtension : ICommonQuery
    {
        private readonly DbProvider _provider;

        public MySqlExtension(DbProvider provider)
        {
            ...
            for (int i = 0; i < args.WhereFields.Count; i++)
            {
                ...
                if (field.Value != null)
                {
                    ...
                    switch (field.WhereType)
                    {
                        ...
                        case WhereType.LeftLike:
                            flag = false;
                            str = MySqlExtension.ReplaceLikeStr(str);
                            str5 = str3;
                        ...
                        case WhereType.In:
                            flag = false;
                            str = MySqlExtension.ReplaceInStr(str);
                            str5 = str3;
