...
namespace SystemManage.Service.IModuleServices
{
    /// <summary>
    /// 管理系统服务
    /// </summary>
    [ServiceBundle("mg/{Service}")]
    public interface IMgService : IServiceKey
    {
        [Service(Date = "2018-9-3", Director = "kason", Name = "管理登陆")]
        //
        Task<CommonActionResult> Login(Sports_BetingInfo info, string password, decimal redBagMoney, string userid);
