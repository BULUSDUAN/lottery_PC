            ...
            try
            {
                ...
                return Json(new LotteryServiceResponse
                {
                    ...
                    Value = new
                    {
                        ...
                        CommissionBalance = balance.CommissionBalance.ToString("0.00"),
                        //CommissionBalance = 0,
                        ExpertsBalance = balance.ExpertsBalance.ToString("0.00"),
                        BonusBalance = balance.BonusBalance.ToString("0.00"),
                        FreezeBalance = balance.FreezeBalance.ToString("0.00"),
                        FillMoneyBalance = balance.FillMoneyBalance.ToString("0.00"),
                        ...
                        RedBagBalance = balance.RedBagBalance.ToString("0.00"),
