...
{
    [Serializable]
    internal class DbTran : IDbTranAccess
    {
        private DbAccessBase _Owner = null;

        protected internal DbTran(DbAccessBase owner)
        {
            _Owner = owner;
        ...
        public void Commit()
        {
            ...
            {
                throw new DbAccessException(ErrorMessages.CommiteError, ex);
            }
            _commited = true;
        }
        ...
        {
            return _Owner.CreateDbConnection();
        }
        /// <summary>
