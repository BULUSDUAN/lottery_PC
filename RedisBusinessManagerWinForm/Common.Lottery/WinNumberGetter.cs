...
using System.Linq;
using System.Text;
using Common.Lottery.WinNumberGetters;
...
namespace Common.Lottery
{
    ...
    /// 中奖号码获取器
    /// </summary>
    public abstract class WinNumberGetter
    {
        /// <summary>
        /// 获取中奖号码
        /// </summary>
        ...
        public abstract Dictionary<string, string> GetWinNumber(string gameCode, int lastIssuseCount, string issuseNumber = "");
        /// <summary>
        /// 创建实例
        /// </summary>
        /// <param name="interfaceType">接口类型</param>
        /// <returns></returns>
        public static WinNumberGetter CreateInstance(string interfaceType)
        {
