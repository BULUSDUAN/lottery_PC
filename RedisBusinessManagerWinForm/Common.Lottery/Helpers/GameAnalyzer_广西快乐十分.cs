...
{
    internal class GameAnalyzer_广西快乐十分 : IOrderAnalyzable, IWinNumberAnalyzable
    {
        public GameAnalyzer_广西快乐十分(string gameCode)
        {
            GameCode = gameCode;
            Spliter = ',';
            TotalNumber = 5;
        ...
        {
            throw new Exception("十一选五玩法不存在占位符");
        }
    }
}
