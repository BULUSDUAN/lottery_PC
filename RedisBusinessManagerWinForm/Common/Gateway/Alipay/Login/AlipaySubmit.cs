...
namespace Common.Gateway.Alipay.Login
{
    /// <summary>
    /// 类名：Submit
    /// 功能：支付宝各接口请求提交类
    ...
    public class Submit
    {
        ...
        /// 初始化请求提交类
        /// </summary>
        /// <param name="partner">商户ID，合作伙伴ID</param>
        /// <param name="key">安全校验码，与partner是一组的</param>
        public Submit(string partner, string key)
        {
        ...
        /// <returns></returns>
        public string BuildRequestString(string return_url)
        {
            //临时请求参数数组
