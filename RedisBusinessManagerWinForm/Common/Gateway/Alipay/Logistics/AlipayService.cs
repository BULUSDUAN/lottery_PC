...
namespace Common.Gateway.Alipay.Logistics
{
    /// <summary>
    /// 类名：Service
    /// 功能：支付宝各接口构造类
    ...
    public class Service
    {
        ...
        /// 从配置文件及入口文件中初始化变量
        /// </summary>
        public Service(string partner, string key)
        {
        ...
        public string User_logistics_address_query(SortedDictionary<string, string> sParaTemp, string return_url)
        {
            _return_url = return_url;
            //增加基本配置
            sParaTemp.Add("service", "user.logistics.address.query");
            ...
            //构造表单提交HTML数据
            var submit = new Submit(Config.Partner, Config.Key);
