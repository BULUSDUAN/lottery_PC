...
namespace Common.XmlAnalyzer
{
    ...
    public static class SettingConfigAnalyzer
    {
        ...
        public static void RegConfigFile(string fileName)
        {
            ...
            {
                Common.Log.LogWriterGetter.GetLogWriter().Write("ConfigChanged", "SettingConfigRegister.Configuration", LogType.Information, "SettingConfigRegister.Configuration", "文件监控发现系统配置文件已更新");
