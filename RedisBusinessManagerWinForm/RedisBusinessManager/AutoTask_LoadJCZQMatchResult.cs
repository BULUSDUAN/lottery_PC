...
namespace RedisBusinessManager
{
    ...
    /// 加载竞彩足球比赛结果
    /// </summary>
    public class AutoTask_LoadJCZQMatchResult : AutoTaskBase, IAutoTask
    {
        public override string LogCategory
        {
            get { return "AutoTask_LoadJCZQMatchResult"; }
        }

        public override string TaskName
        {
            get { return "加载竞彩足球比赛结果"; }
        }
        ...
        private void AutoDoTask()
        {
            try
            {
                ...
                var span = int.Parse(ConfigurationManager.AppSettings["TimeSpan_Load_JCZQMatchResult"]);
