...
namespace Lottery.Kg.ORM.Helper.WinNumber.Model
{
    ...
    /// 重庆5星基本走势
    /// </summary>
    public class CQSSC_5X_JBZS : ImportBase
    {
        ...
        public virtual int Red_W0 { get; set; }
        public virtual int Red_W1 { get; set; }
        public virtual int Red_W2 { get; set; }
        public virtual int Red_W3 { get; set; }
        public virtual int Red_W4 { get; set; }
        public virtual int Red_W5 { get; set; }
        public virtual int Red_W6 { get; set; }
        public virtual int Red_W7 { get; set; }
        public virtual int Red_W8 { get; set; }
        public virtual int Red_W9 { get; set; }

        public virtual int Red_Q0 { get; set; }
        public virtual int Red_Q1 { get; set; }
        public virtual int Red_Q2 { get; set; }
        public virtual int Red_Q3 { get; set; }
        public virtual int Red_Q4 { get; set; }
        public virtual int Red_Q5 { get; set; }
        public virtual int Red_Q6 { get; set; }
        public virtual int Red_Q7 { get; set; }
        public virtual int Red_Q8 { get; set; }
        public virtual int Red_Q9 { get; set; }
