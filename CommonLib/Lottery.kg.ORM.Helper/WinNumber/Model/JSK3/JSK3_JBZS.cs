...
namespace Lottery.Kg.ORM.Helper.WinNumber.Model
{
    ...
    /// 基本走势
    /// </summary>
    public class JSK3_JBZS : ImportBase
    {
        ...
        /// 奇的个数
        /// </summary>
        public virtual int JiCount_0 { get; set; }
        public virtual int JiCount_1 { get; set; }
        public virtual int JiCount_2 { get; set; }
        public virtual int JiCount_3 { get; set; }

        /// <summary>
        ///小的个数
        /// </summary>
        public virtual int XiaoCount_0 { get; set; }
        public virtual int XiaoCount_1 { get; set; }
        public virtual int XiaoCount_2 { get; set; }
        public virtual int XiaoCount_3 { get; set; }
