...
namespace KaSon.FrameWork.ORM.Helper.WinNumber.Model
{
    ...
    /// 2连走势
    /// </summary>
    public class CQKLSF_2LZS : ImportBase
    {
        ...
        public virtual int Red_1516 { get; set; }
        public virtual int Red_1617 { get; set; }
        public virtual int Red_1718 { get; set; }
        public virtual int Red_1819 { get; set; }
        public virtual int Red_1920 { get; set; }
