...
{
    public class HC1_JBZS : ImportBase
    {
        ...
        public virtual int Red_21 { get; set; }
        public virtual int Red_22 { get; set; }
        public virtual int Red_23 { get; set; }
        public virtual int Red_24 { get; set; }
        public virtual int Red_25 { get; set; }
        public virtual int Red_26 { get; set; }
        public virtual int Red_27 { get; set; }
        public virtual int Red_28 { get; set; }
        public virtual int Red_29 { get; set; }

        public virtual int Red_30 { get; set; }
        public virtual int Red_31 { get; set; }
        public virtual int Red_32 { get; set; }
        public virtual int Red_33 { get; set; }
        public virtual int Red_34 { get; set; }
        public virtual int Red_35 { get; set; }
        public virtual int Red_36 { get; set; }
    }
}
