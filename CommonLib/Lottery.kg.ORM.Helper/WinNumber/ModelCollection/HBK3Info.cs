...
namespace Lottery.Kg.ORM.Helper.WinNumber.ModelCollection
{
    ...
    public class HBK3_JBZS_Info : ImportInfoBase
    {
    ...
    public class HBK3_JBZS_InfoCollection : List<HBK3_JBZS_Info>
    {
    }
    ...
    public class HBK3_HZ_Info : ImportInfoBase
    {
        /// <summary>
        /// 和值
        /// </summary>
    ...
    public class HBK3_HZ_InfoCollection : List<HBK3_HZ_Info>
    {
    }
    ...
    public class HBK3_XT_Info : ImportInfoBase
    {
        public int Red_1 { get; set; }
        public int Red_2 { get; set; }
        public int Red_3 { get; set; }
    ...
    public class HBK3_XT_InfoCollection : List<HBK3_XT_Info>
    {
    }
    ...
    public class HBK3_ZH_Info : ImportInfoBase
    {
        public int Red_1 { get; set; }
        public int Red_2 { get; set; }
        public int Red_3 { get; set; }
    ...
    public class HBK3_ZH_InfoCollection : List<HBK3_ZH_Info>
    {
    }
    ...
    public class HBK3_ZHZS_Info : ImportInfoBase
    {
        public int Red_1 { get; set; }
        public int Red_2 { get; set; }
        public int Red_3 { get; set; }
    ...
    public class HBK3_ZHZS_InfoCollection : List<HBK3_ZHZS_Info>
    {
    }
