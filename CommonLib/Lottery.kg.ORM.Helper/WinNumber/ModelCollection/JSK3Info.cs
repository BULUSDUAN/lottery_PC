...
namespace Lottery.Kg.ORM.Helper.WinNumber.ModelCollection
{
    ...
    public class JSK3_JBZS_Info : ImportInfoBase
    {
    ...
    public class JSK3_JBZS_InfoCollection : List<JSK3_JBZS_Info>
    {
    }
    ...
    public class JSK3_HZ_Info : ImportInfoBase
    {
        /// <summary>
        /// 和值
        /// </summary>
    ...
    public class JSK3_HZ_InfoCollection : List<JSK3_HZ_Info>
    {
    }
    ...
    public class JSK3_XT_Info : ImportInfoBase
    {
        public int Red_1 { get; set; }
        public int Red_2 { get; set; }
        public int Red_3 { get; set; }
    ...
    public class JSK3_XT_InfoCollection : List<JSK3_XT_Info>
    {
    }
    ...
    public class JSK3_ZH_Info : ImportInfoBase
    {
        public int Red_1 { get; set; }
        public int Red_2 { get; set; }
        public int Red_3 { get; set; }
    ...
    public class JSK3_ZH_InfoCollection : List<JSK3_ZH_Info>
    {
    }
    ...
    public class JSK3_ZHZS_Info : ImportInfoBase
    {
        public int Red_1 { get; set; }
        public int Red_2 { get; set; }
        public int Red_3 { get; set; }
    ...
    public class JSK3_ZHZS_InfoCollection : List<JSK3_ZHZS_Info>
    {
    }
