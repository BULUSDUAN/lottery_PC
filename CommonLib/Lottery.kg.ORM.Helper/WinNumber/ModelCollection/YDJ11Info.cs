...
namespace KaSon.FrameWork.ORM.Helper.WinNumber.ModelCollection
{
    ...
    public class YDJ11_012DWZS_Info : ImportInfoBase
    {
    ...
    public class YDJ11_012DWZS_InfoCollection : List<YDJ11_012DWZS_Info>
    {
    }

     
    public class YDJ11_012LZZS_Info : ImportInfoBase
    {
    ...
    public class YDJ11_012LZZS_InfoCollection : List<YDJ11_012LZZS_Info>
    {
    }
    /// <summary>
    /// 2连走势
    ...
    public class YDJ11_2LZS_Info : ImportInfoBase
    {
    ...
    public class YDJ11_2LZS_InfoCollection : List<YDJ11_2LZS_Info>
    {
    }
    /// <summary>
    /// 重号走势
    ...
    public class YDJ11_CHZS_Info : ImportInfoBase
    {
    ...
    public class YDJ11_CHZS_InfoCollection : List<YDJ11_CHZS_Info>
    {
    }
    /// <summary>
    /// 多连走势
    ...
    public class YDJ11_DLZS_Info : ImportInfoBase
    {
    ...
    public class YDJ11_DLZS_InfoCollection : List<YDJ11_DLZS_Info>
    {
    }
    /// <summary>
    /// 隔号走势
    ...
    public class YDJ11_GHZS_Info : ImportInfoBase
    {
    ...
    public class YDJ11_GHZS_InfoCollection : List<YDJ11_GHZS_Info>
    {
    }
    /// <summary>
    /// 和值走势
    ...
    public class YDJ11_HZZS_Info : ImportInfoBase
    {
    ...
    public class YDJ11_HZZS_InfoCollection : List<YDJ11_HZZS_Info>
    {
    }

     
    public class YDJ11_JBZS_Info : ImportInfoBase
    {
        public int Red_01 { get; set; }
        public int Red_02 { get; set; }
        public int Red_03 { get; set; }
    ...
    public class YDJ11_JBZS_InfoCollection : List<YDJ11_JBZS_Info>
    {
    }
    /// <summary>
    /// 跨度走势
    ...
    public class YDJ11_KDZS_Info : ImportInfoBase
    {
    ...
    public class YDJ11_KDZS_InfoCollection : List<YDJ11_KDZS_Info>
    {
    }
    /// <summary>
    /// 前1走势
    ...
    public class YDJ11_Q1JBZS_Info : ImportInfoBase
    {
        public int Red_01 { get; set; }
        public int Red_02 { get; set; }
        public int Red_03 { get; set; }
    ...
    public class YDJ11_Q1JBZS_InfoCollection : List<YDJ11_Q1JBZS_Info>
    {
    }
    /// <summary>
    /// 前1形态走势
    ...
    public class YDJ11_Q1XTZS_Info : ImportInfoBase
    {
        public int Red_01 { get; set; }
        public int Red_02 { get; set; }
        public int Red_03 { get; set; }
    ...
    public class YDJ11_Q1XTZS_InfoCollection : List<YDJ11_Q1XTZS_Info>
    {
    }
    /// <summary>
    /// 前2走势
    ...
    public class YDJ11_Q2JBZS_Info : ImportInfoBase
    {
        public int Red_01 { get; set; }
        public int Red_02 { get; set; }
        public int Red_03 { get; set; }
    ...
    public class YDJ11_Q2JBZS_InfoCollection : List<YDJ11_Q2JBZS_Info>
    {
    }
    /// <summary>
    /// 前2形态走势
    ...
    public class YDJ11_Q2XTZS_Info : ImportInfoBase
    {
        public int DDan { get; set; }
        public int DS { get; set; }
        public int XDan { get; set; }
    ...
    public class YDJ11_Q2XTZS_InfoCollection : List<YDJ11_Q2XTZS_Info>
    {
    }
    /// <summary>
    /// 前3走势
    ...
    public class YDJ11_Q3JBZS_Info : ImportInfoBase
    {
        public int Red_01 { get; set; }
        public int Red_02 { get; set; }
        public int Red_03 { get; set; }
    ...
    public class YDJ11_Q3JBZS_InfoCollection : List<YDJ11_Q3JBZS_Info>
    {
    }
    /// <summary>
    /// 前3形态走势
    ...
    public class YDJ11_Q3XTZS_Info : ImportInfoBase
    {
        public int DDan { get; set; }
        public int DS { get; set; }
        public int XDan { get; set; }
    ...
    public class YDJ11_Q3XTZS_InfoCollection : List<YDJ11_Q3XTZS_Info>
    {
    }

     
    public class YDJ11_XTZS_Info : ImportInfoBase
    {
    ...
    public class YDJ11_XTZS_InfoCollection : List<YDJ11_XTZS_Info>
    {
    }
}
