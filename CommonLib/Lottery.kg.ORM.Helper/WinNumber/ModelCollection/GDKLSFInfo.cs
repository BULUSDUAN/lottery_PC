...
namespace KaSon.FrameWork.ORM.Helper.WinNumber.ModelCollection
{
    ...
    public class GDKLSF_JBZS_Info : ImportInfoBase
    {
        ...
        /// 奇偶比例
        /// </summary>
        public string JO_Bi { get; set; }
        /// <summary>
        /// 大小比例
        /// </summary>
        public string DX_Bi { get; set; }
        /// <summary>
        /// 质数
        /// </summary>
        public int ZhiCount { get; set; }


    }

     
    public class GDKLSF_JBZS_InfoCollection : List<GDKLSF_JBZS_Info>
    {
    }
    ...
    public class GDKLSF_DW1_Info : ImportInfoBase
    {
        public int Red_01 { get; set; }
        public int Red_02 { get; set; }
        public int Red_03 { get; set; }
    ...
    public class GDKLSF_DW1_InfoCollection : List<GDKLSF_DW1_Info>
    {
    }
    ...
    public class GDKLSF_DW2_Info : ImportInfoBase
    {
        public int Red_01 { get; set; }
        public int Red_02 { get; set; }
        public int Red_03 { get; set; }
    ...
    public class GDKLSF_DW2_InfoCollection : List<GDKLSF_DW2_Info>
    {
    }
    ...
    public class GDKLSF_DW3_Info : ImportInfoBase
    {
        public int Red_01 { get; set; }
        public int Red_02 { get; set; }
        public int Red_03 { get; set; }
    ...
    public class GDKLSF_DW3_InfoCollection : List<GDKLSF_DW3_Info>
    {
    }
    ...
    public class GDKLSF_DX_Info : ImportInfoBase
    {
        /// <summary>
        /// 大小遗漏
        /// </summary>
    ...
    public class GDKLSF_DX_InfoCollection : List<GDKLSF_DX_Info>
    {
    }
    ...
    public class GDKLSF_JO_Info : ImportInfoBase
    {
        /// <summary>
        /// 奇偶遗漏
        /// </summary>
    ...
    public class GDKLSF_JO_InfoCollection : List<GDKLSF_JO_Info>
    {
    }
    ...
    public class GDKLSF_ZH_Info : ImportInfoBase
    {
        /// <summary>
        /// 质和遗漏
        /// </summary>
    ...
    public class GDKLSF_ZH_InfoCollection : List<GDKLSF_ZH_Info>
    {
    }
