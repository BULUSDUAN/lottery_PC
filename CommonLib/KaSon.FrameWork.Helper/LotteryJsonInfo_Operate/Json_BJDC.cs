    ...
    public class Json_BJDC
    {
        ...
        public static List<BJDC_MatchInfo_WEB> MatchList_WEB(string issuse, string gameType, bool isLeftJoin = true)
        {
            ...
            foreach (var item in match)
            {
                ...
                var info = new BJDC_MatchInfo_WEB()
                {
                    ...
                    LocalStopTime = bizHelper.ConvertDateTimeInt(Convert.ToDateTime(item.LocalStopTime)).ToString(),
                    ...
                    MatchStartTime = bizHelper.ConvertDateTimeInt(Convert.ToDateTime(item.MatchStartTime)).ToString(),
        ...
        public static string BJDC_SPF_JSON(string issuse, string gameType)
        {
            ...
            foreach (var item in match)
            {
                ...
                json.AppendFormat("\"{0}\",", item.MatchColor);//BusinessHelper.GetLeagueColor()
                json.AppendFormat("\"{0}\",", item.MatchStartTime);
                json.Append("\"\",");
                json.Append("\"0\",");
