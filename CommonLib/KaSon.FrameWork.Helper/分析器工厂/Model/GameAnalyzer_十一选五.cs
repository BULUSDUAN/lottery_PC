...
{
    internal class GameAnalyzer_十一选五 : IOrderAnalyzable, IWinNumberAnalyzable
    {
        public GameAnalyzer_十一选五(string gameCode)
        {
            GameCode = gameCode;
            Spliter = ',';
            TotalNumber = 5;
