...
{
    internal class GameAnalyzer_广东快乐十分 : IOrderAnalyzable, IWinNumberAnalyzable
    {
        public GameAnalyzer_广东快乐十分(string gameCode)
        {
            GameCode = gameCode;
            Spliter = ',';
            TotalNumber = 8;
        ...
        {
            throw new Exception("广东快乐十分玩法不存在占位符");
        }
    }
}
