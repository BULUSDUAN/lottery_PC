...
namespace KaSon.FrameWork.ORM.Helper.WinNumber.ModelCollection
{
    ...
    public class HNKLSF_2LZS_Info : ImportInfoBase
    {
    ...
    public class HNKLSF_2LZS_InfoCollection : List<HNKLSF_2LZS_Info>
    {
    }
     
    public class HNKLSF_3LZS_Info : ImportInfoBase
    {
    ...
    public class HNKLSF_3LZS_InfoCollection : List<HNKLSF_3LZS_Info>
    {
    }
     
    public class HNKLSF_DXZS_Info : ImportInfoBase
    {
        public int DX1_D { set; get; }
        public int DX1_X { set; get; }
        public int DX2_D { set; get; }
        public int DX2_X { set; get; }
        public int DX3_D { set; get; }
        public int DX3_X { set; get; }
        public int DX4_D { set; get; }
        public int DX4_X { set; get; }
        public int DX5_D { set; get; }
        public int DX5_X { set; get; }
        public int DX6_D { set; get; }
        public int DX6_X { set; get; }
        public int DX7_D { set; get; }
        public int DX7_X { set; get; }
        public int DX8_D { set; get; }
        public int DX8_X { set; get; }
    ...
    public class HNKLSF_DXZS_InfoCollection : List<HNKLSF_DXZS_Info>
    {
    }
     
    public class HNKLSF_GHZS_Info : ImportInfoBase
    {
    ...
    public class HNKLSF_GHZS_InfoCollection : List<HNKLSF_GHZS_Info>
    {
    }
     
    public class HNKLSF_JBZS_Info : ImportInfoBase
    {
    ...
    public class HNKLSF_JBZS_InfoCollection : List<HNKLSF_JBZS_Info>
    {
    }
     
    public class HNKLSF_JOZS_Info : ImportInfoBase
    {
        public int JO1_J { set; get; }
        public int JO1_O { set; get; }
        public int JO2_J { set; get; }
        public int JO2_O { set; get; }
        public int JO3_J { set; get; }
        public int JO3_O { set; get; }
        public int JO4_J { set; get; }
        public int JO4_O { set; get; }
        public int JO5_J { set; get; }
        public int JO5_O { set; get; }
        public int JO6_J { set; get; }
        public int JO6_O { set; get; }
        public int JO7_J { set; get; }
        public int JO7_O { set; get; }
        public int JO8_J { set; get; }
        public int JO8_O { set; get; }
    ...
    public class HNKLSF_JOZS_InfoCollection : List<HNKLSF_JOZS_Info>
    {
    }
     
    public class HNKLSF_Q1ZS_Info : ImportInfoBase
    {
        public int Red_01 { get; set; }
        public int Red_02 { get; set; }
        public int Red_03 { get; set; }
    ...
    public class HNKLSF_Q1ZS_InfoCollection : List<HNKLSF_Q1ZS_Info>
    {
    }
     
    public class HNKLSF_Q3ZS_Info : ImportInfoBase
    {
        public int DDan { get; set; }
        public int DS { get; set; }
        public int XDan { get; set; }
    ...
    public class HNKLSF_Q3ZS_InfoCollection : List<HNKLSF_Q3ZS_Info>
    {
    }
     
    public class HNKLSF_QJZS_Info : ImportInfoBase
    {
    ...
    public class HNKLSF_QJZS_InfoCollection : List<HNKLSF_QJZS_Info>
    {
    }
     
    public class HNKLSF_TWZS_Info : ImportInfoBase
    {
    ...
    public class HNKLSF_TWZS_InfoCollection : List<HNKLSF_TWZS_Info>
    {
    }
}
