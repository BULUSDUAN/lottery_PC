...
namespace KaSon.FrameWork.ORM.Helper.WinNumber.Model
{
    ...
    /// 和值走势
    /// </summary>
    public class CQSSC_5X_HZZS : ImportBase
    {
        ...
        public virtual int HZ_28 { get; set; }
        public virtual int HZ_29 { get; set; }
        public virtual int HZ_30 { get; set; }
        public virtual int HZ_31 { get; set; }
        public virtual int HZ_32 { get; set; }
        public virtual int HZ_33 { get; set; }
        public virtual int HZ_34 { get; set; }
        public virtual int HZ_35 { get; set; }
        public virtual int HZ_36 { get; set; }
        public virtual int HZ_37 { get; set; }
        public virtual int HZ_38 { get; set; }
        public virtual int HZ_39 { get; set; }
        public virtual int HZ_40 { get; set; }
        public virtual int HZ_41 { get; set; }
        public virtual int HZ_42 { get; set; }
        public virtual int HZ_43 { get; set; }
        public virtual int HZ_44 { get; set; }
        public virtual int HZ_45 { get; set; }
