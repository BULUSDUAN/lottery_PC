...
{
    public class GDKLSF_DW3 : ImportBase
    {
        ...
        public virtual int NODX_D { get; set; }
        public virtual int NODX_X { get; set; }
        public virtual int NOJO_J { get; set; }
        public virtual int NOJO_O { get; set; }
        public virtual int NOZH_Z { get; set; }
        public virtual int NOZH_H { get; set; }
