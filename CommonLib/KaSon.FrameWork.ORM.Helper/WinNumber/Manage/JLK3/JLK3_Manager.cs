...
namespace KaSon.FrameWork.ORM.Helper.WinNumber.Manage
{
    public class JLK3_Manager : DBbase
    {
        ...
        public int QueryJLK3_JBZSIssuseNumber(string issuseNumber)
        {
            ...
            return LottertDataDB.CreateQuery<JLK3_JBZS>().Where(p => p.IssuseNumber == issuseNumber).Count();
        }
        ...
        public int QueryJLK3_HZIssuseNumber(string issuseNumber)
        {
            ...
            return LottertDataDB.CreateQuery<JLK3_HZ>().Where(p => p.IssuseNumber == issuseNumber).Count();
        }
        ...
        public int QueryJLK3_XTIssuseNumber(string issuseNumber)
        {
            ...
            return LottertDataDB.CreateQuery<JLK3_XT>().Where(p => p.IssuseNumber == issuseNumber).Count();
        }
        ...
        public int QueryJLK3_ZHIssuseNumber(string issuseNumber)
        {
            ...
            return LottertDataDB.CreateQuery<JLK3_ZH>().Where(p => p.IssuseNumber == issuseNumber).Count();
        }
        ...
        public int QueryJLK3_ZHZSIssuseNumber(string issuseNumber)
        {
            ...
            return LottertDataDB.CreateQuery<JLK3_ZHZS>().Where(p => p.IssuseNumber == issuseNumber).Count();
        }
