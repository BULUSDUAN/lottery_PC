...
namespace KaSon.FrameWork.ORM.Helper
{
     public class UserBalanceManager:DBbase
    {
        ...
        //    var query = DB.CreateSQLQuery(sql).List<MemberSpreadInfoCollection>();
        ...
        //        {
        //            var array = item as object[];
        //            list.infoList.Add(new MemberSpreadInfo { ProvinceName = array[0].ToString(), tcount = Convert.ToInt32(array[1]) });
        //        }
        //        return list;
        //    }
        //    else
        ...
        //    var queryFm = this.Session.CreateSQLQuery(sqlFm).List();
        ...
        //    var querywd = this.Session.CreateSQLQuery(sqlwd).List();
        //    FillMoneyWithdrawInfoCollection list = new FillMoneyWithdrawInfoCollection();
        //    if (queryFm != null && queryFm.Count > 0)
        //    {
        //        foreach (var item in queryFm)
        //        {
        //            var array = item as object[];
        //            list.fillMoneyInfoList.Add(new FillMoneyWithdrawInfo { Month = array[0].ToString(), TotalMoney = Convert.ToInt32(array[1]) });
        //        }
        //    }
        //    if (querywd != null && querywd.Count > 0)
        //    {
        //        foreach (var item in querywd)
        //        {
        //            var array = item as object[];
        //            list.WithdrawInfoList.Add(new FillMoneyWithdrawInfo { Month = array[0].ToString(), TotalMoney = Convert.ToInt32(array[1]) });
        //        }
        //    }
        //    return list;
        //}
        ...
        //    var query = this.Session.CreateSQLQuery(sqlStr).List();
        ...
        //        {
        //            var array = item as object[];
        //            mtc.list.Add(new MemberTotalInfo
        //            {
        //                Day = array[0].ToString(),
        //                TotalCount = Convert.ToInt32(array[1]),
        //                PcTotalCount = Convert.ToInt32(array[2]),
        //                TouchTotalCount = Convert.ToInt32(array[3]),
        //                NewTouchTotalCount = Convert.ToInt32(array[4]),
        //                AndroidTotalCount = Convert.ToInt32(array[5]),
        //                IosTotalCount = Convert.ToInt32(array[6]),
        //                FillMoneyTotalCount = Convert.ToInt32(array[7]),
        //                AuthTotalCount = Convert.ToInt32(array[8]),
        //                NewAndroidCount = Convert.ToInt32(array[9]),
        //                NewIOSCount = Convert.ToInt32(array[10])
        //            });
        //        }
        //    }
        //    return mtc;
