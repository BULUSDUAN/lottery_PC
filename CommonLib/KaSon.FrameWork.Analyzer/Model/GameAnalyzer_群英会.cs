...
{
    internal class GameAnalyzer_群英会 : IOrderAnalyzable, IWinNumberAnalyzable
    {
        public GameAnalyzer_群英会(string gameCode)
        {
            GameCode = gameCode;
            Spliter = ',';
            TotalNumber = 5;
